...
## Exercise History Seed
ExerciseHistory.delete_all

workout_id = 1
user_id = 1
exercise_id = 1
performance_datas = [
  { weight: 200, reps: 3, sets: 1 },
  { weight: 205, reps: 3, sets: 1 },
  { weight: 215, reps: 3, sets: 1 },
]

performance_datas.each do |performance_data|
